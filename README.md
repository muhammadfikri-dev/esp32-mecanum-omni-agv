# ⚡ ESP32 Mecanum Wheel Omni-Directional AGV with Path Planning
...
Omni-directional automated guided vehicle using 4-wheel independent kinematic matrix, AS5600 wheel encoders, magnetic tape guide tracking, and ROS2 micro-XRCE bridge.
...
3. Pastikan dependensi pustaka terpasang:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-mecanum-omni-agv.ino`](./esp32-mecanum-omni-agv.ino).
