/**
 * =========================================================================================
 * Project     : ESP32 Mecanum Wheel Omni-Directional AGV with Path Planning
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Omni-directional automated guided vehicle using 4-wheel independent kinematic matrix, AS5600 wheel encoders, magnetic tape guide tracking, and ROS2 micro-XRCE bridge.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-mecanum-omni-agv";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Mecanum Wheel Omni-Directional AGV with Path Planning"));
